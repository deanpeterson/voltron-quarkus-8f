...
export IMAGE_URL=${IMAGE_URL-quay-quay-quay-test.apps.salamander.aimlworkbench.com/rhdh/voltron-quarkus-8f:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/deanpeterson/voltron-quarkus-8f-gitops
